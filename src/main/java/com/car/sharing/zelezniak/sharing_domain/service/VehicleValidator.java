...
public class VehicleValidator {
    ...
    public void throwExceptionIfVehicleExists(String registrationNumber){
    ...
    public void checkIfVehicleCanBeUpdated(String registrationNumber, Vehicle newData) {
    ...
    private boolean registrationsAreNotSame(String registrationNumber, String newDataRegistrationNumber) {
